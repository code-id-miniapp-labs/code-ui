import { computedBehavior, createComponentOptions } from "@code-ui/components";
...
Component(
  createComponentOptions({
    ...
    methods: {
      ...
      handleFilterCategory(e: WechatMiniprogram.CustomEvent<{ cat: string }>) {
